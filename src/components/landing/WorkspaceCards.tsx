  ...
  return (
    ...
    >
      ...
      <div className="p-8 flex flex-col flex-1">
        ...
        <p className="text-slate-500 text-sm mb-6 flex-1 min-h-[40px]">
          {data.description}
        </p>
        ...
        <ul className="space-y-3 mb-8">
          {data.features.map((feature, i) => (
            <li key={i} className="flex items-start gap-2 text-sm text-slate-600">
              <CheckCircle2 className={`w-4 h-4 mt-0.5 text-${data.theme}-500 shrink-0`} />
              <span>{feature}</span>
            </li>
          ))}
        </ul>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-10 py-2.5 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors"
          ...
          <div className="flex items-center justify-between text-xs text-slate-500 px-1">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" defaultChecked className="rounded border-slate-300 bg-transparent text-indigo-600 focus:ring-0 focus:ring-offset-0" />
        ...
        <div className="mt-6 flex flex-col items-center gap-4">
          ...
          <div className="flex gap-3 w-full">
            <button type="button" className="flex-1 py-2 rounded-xl bg-white border border-slate-200 hover:bg-slate-50 shadow-sm transition-colors flex items-center justify-center">
          ...
          <p className="text-[10px] text-slate-400 mt-2">Demo credentials pre-filled for testing</p>
        </div>
        ...
        <div className="mt-8 pt-4 border-t border-slate-100 flex items-center gap-3">
          ...
          <div>
            ...
            <div className={`text-xs text-${data.theme}-600`}>{data.accountType}</div>
          </div>
        </div>
      </div>
    </motion.div>
...
export const WorkspaceCards: React.FC<WorkspaceCardsProps> = ({ onLogin }) => {
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-indigo-100/60 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 text-sm font-medium text-indigo-700 mb-6 backdrop-blur-md">
