...
export const OrganizerWorkspace: React.FC<OrganizerWorkspaceProps> = ({
  ...
  const announcements = (propsAnnouncements && propsAnnouncements.length > 0) ? propsAnnouncements : storeAnnouncements;
                        ...
                        <div className="flex gap-2">
                          <button
                            onClick={() => {
                              ...
                              setBanner(h.banner);
                              setMode((h.mode ? h.mode.toLowerCase() : 'online') as any);
